  ...
  function App() {
    ...
    // Since useCurrencyinfo(from) fetches data asynchronously, currencyinfo will be undefined initially.
    // You should handle the case where currencyinfo[to] is undefined.
    const convert = () => {
      if (currencyinfo && currencyinfo[to]) {
        setConvertedAmount(amount * currencyinfo[to]);
      } else {
        console.error("Conversion data is not available yet.");
      }
    };
